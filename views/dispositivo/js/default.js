$(document).ready(function(){
    ...
    function llenar_tabla(){
			...
			success: function(res){
				...
				$.each(res.datos, function(data) {
						usuario.append($("<option />").val(data.id).text(data.nombre));
				});
   			...
   			if(r == true){//tengo que ir a por los datos
				...
				$.ajax({
					...
					success: function(res){
						...
						$("#txt_EditarUsuario").val(res.datos[0]['usuario']);
						$("#txt_EditarIp").val(res.datos[0]['ip']);
